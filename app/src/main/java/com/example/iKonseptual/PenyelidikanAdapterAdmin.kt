...
class PenyelidikanAdapterAdmin (
    private val context: Context,
    private val dataList: List<DataPenyelidikanPenyidikan>,
    private var onClickListener: OnClickListener? = null
) : RecyclerView.Adapter<PenyelidikanAdapterAdmin.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.card.setOnClickListener {
            ...
            val labelEdit = "Edit Rincian Penyelidikan"
            val role = 0
            val intent = Intent(context, RincianActivity::class.java).apply {
                ...
                putExtra("Id", dataPenyelidikanPenyidikan.no)
